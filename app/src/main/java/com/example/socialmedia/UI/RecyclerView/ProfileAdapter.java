...
public class ProfileAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ProfileAdapter(User user, Context context, List<Post> postList) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof HeaderViewHolder) {
            ...
            ((PostViewHolder) holder).bind(postList.get(position - 1), context);
        }
    }
    ...
    public static class HeaderViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView nameUser, text, addFriend, deleteFriend, sendMessage, acceptFriendRequest, rejectFriendRequest;
    ...
    public static class PostViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(Post post, Context context) {
            ...
            if (post.getLink().contains(".mp4")) {
                ...
                Glide.with(context).load(post.getLink()).placeholder(R.drawable.wait_download).into(imagePost);
            } else {
                imagePost.setVisibility(View.GONE);
                videoPost.setVisibility(View.GONE);
            }
