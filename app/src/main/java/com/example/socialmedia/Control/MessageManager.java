...
public class MessageManager {
    ...
    public void DeleteMessagesChat(String chatId, MessageRepository.DeleteMessageCallBack callBack) {
        messageRepository.DeleteMessagesChat(chatId, new MessageRepository.DeleteMessageCallBack() {
            @Override
            public void onSuccess() {
